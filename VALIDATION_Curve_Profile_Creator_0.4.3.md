...
4. PARAMETRIC/STATIC certification behaviour matches 0.4.2.
...
Expected: no modelling behaviour change from the validated baseline.
...
### Acceptance
0.4.3 is accepted when category creation/rename, global search, metadata editing and indexed/lazy thumbnail browsing work as specified while all protected CPC modelling/persistence behaviour remains intact.
